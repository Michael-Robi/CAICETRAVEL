...
if(isset($_POST['btnGrabar']))
{
	...
	if($revisar !== false){
		try
		{
			...
			$sql2="UPDATE hotel SET imagen='$imagen2' WHERE codigo='$codigo'";
	...
	<form class="col s12 m12 l12" name="enviar" method="POST" enctype="multipart/form-data">
			...
			if(isset($error))
			{
			 	foreach($error as $error)
			 	{
					?>
					    ...
					    <?php echo "window.location='actualizarHotelImg.php?codigoS=$codigo'"; 
					    ?>    
					    </script> 
	                <?php
				}
		...
		<div class="col">
			...
			<div class="col">
				...
				<div class="input-field col s3 m1 l1 pull-s3 offset-l3 offset-m3" style="margin-top: 0rem;">
