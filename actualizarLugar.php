...
$sql="select * from lugar where codigo='$codigo'";
...
if(isset($_POST['btnGrabar']))
{
	...
	if($codigo1=="") {
		...
		try
		{
			$stmt = $administrador->runQuery("SELECT descripcion, ubicacion, latitud, longitud FROM lugar WHERE descripcion=:descripcion1 OR ubicacion=:ubicacion1 OR latitud=:latitud1 OR longitud=:longitud1");
			...
			{
				$sql2="UPDATE lugar SET descripcion='$descripcion1', detalle='$detalle1', ubicacion='$ubicacion1', latitud='$latitud1', longitud='$longitud1', tipo='$tipo' WHERE codigo='$codigo1'";
				...
				echo'<script type="text/javascript">
	      		...
	      		window.location="listaLugar.php"
	     		</script>';
			}
		}
	...
	<form class="col s12 m12 l12" name="enviar" method="POST" enctype="multipart/form-data">
			 	...
			 	foreach($error as $error)
			 	{
					?>
	                    <script type="text/javascript">
					        ...
					        <?php echo "window.location='actualizarLugar.php?codigoS=$codigo&tipoS=$tipo'"; 
					    	?>    
					    </script> 
	                <?php
				}
		...
		<div class="col">
			...
			<div style="margin-top: 0rem;" class="input-field col s12 m8 l6 offset-l1 offset-m1">
				...
				<article>
					<h5 class="color">ACTUALIZAR SITIO TURISTICO</h5>
				</article>
			</div>
			...
			<!-- <div class="input-field col s12 m8 l6 offset-l1 offset-m1"> -->
				...
				<input maxLength="10" type="hidden" id="codigoo" name="codigoo1" onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;" placeholder=" Ingrese el codigo" class="color" value="<?php echo $fila['codigo']; ?>" required>
		    ...
		    <div class="input-field col s12 m8 l6 offset-l1 offset-m1">
				...
				<input maxLength="30" type="text" pattern="-?[A-Za-záéíóúÁÉÍÓÚÑñ #-]*" id="descripcionn" name="descripcionn1" placeholder=" Ingrese el nombre del sitio turistico" class="color" value="<?php echo $fila['descripcion']; ?>" required>
			...
			<div class="input-field col s12 m8 l6 offset-l1 offset-m1">
				...
				<textarea maxLength="300" id="detalle1" name="detallee1" rows=5 cols=40 class="materialize-textarea" placeholder=" Ingrese el detalle de los servicios que ofrece el sitio turistico" required><?php echo $fila['detalle']; ?></textarea>
			...
			<div class="input-field col s10 m8 l6 offset-l1 offset-m1">
				...
				<input maxLength="45" type="text" pattern="-?[A-Za-záéíóúÁÉÍÓÚÑñ 0-9 #-]*" id="search" name="ubicacionn1" class="color" placeholder=" Ingrese la direccion" value="<?php echo $fila['ubicacion']; ?>" required>
