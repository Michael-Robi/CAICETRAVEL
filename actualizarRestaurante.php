...
$sql="select * from restaurante where codigo='$codigo'";
...
if(isset($_POST['btnGrabar']))
{
	...
	if($codigo3=="") {
		...
		try
		{
			$stmt = $administrador->runQuery("SELECT descripcion, ubicacion, latitud, longitud FROM restaurante WHERE descripcion=:descripcion3 OR ubicacion=:ubicacion3 OR latitud=:latitud3 OR longitud=:longitud3");
			$stmt->execute(array(':descripcion3'=>$descripcion3, ':ubicacion3'=>$ubicacion3, ':latitud3'=>$latitud3, ':longitud3'=>$longitud3));
			$row=$stmt->fetch(PDO::FETCH_ASSOC);
				
			if($row['descripcion']==$descripcion3) {
			...
			{
				$sql2="UPDATE restaurante SET descripcion='$descripcion3', detalle='$detalle3', ubicacion='$ubicacion3', latitud='$latitud3', longitud='$longitud3', tipo='$tipo' WHERE codigo='$codigo3'";
				...
				echo'<script type="text/javascript">
	      		...
	      		window.location="listaRestaurante.php"
	     		</script>';
			}
		}
	...
	<form class="col s12 m12 l12" name="enviar" method="POST" enctype="multipart/form-data">
			 	...
			 	foreach($error as $error)
			 	{
					?>
	                    <script type="text/javascript">
					        ...
					        <?php echo "window.location='actualizarRestaurante.php?codigoS=$codigo&tipoS=$tipo'"; 
					    	?>
					    </script> 
	                <?php
				}
		...
		<div class="col">
			...
			<div style="margin-top: 0rem;" class="input-field col s12 m8 l6 offset-l1 offset-m1">
				...
				<article>
					<h5 class="color">ACTUALIZAR RESTAURANTE</h5>
				</article>
			</div>
			...
			<div class="input-field col s12 m8 l6 offset-l1 offset-m1">
				...
				<input maxLength="10" type="text" id="codigoo" name="codigoo3" onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;" placeholder=" Ingrese el codigo" class="color" value="<?php echo $fila['codigo']; ?>" required>
		    ...
		    <div class="input-field col s12 m8 l6 offset-l1 offset-m1">
				...
				<input maxLength="30" type="text" pattern="-?[A-Za-záéíóúÁÉÍÓÚÑñ #-]*" id="descripcionn" name="descripcionn3" placeholder=" Ingrese el nombre del restaurante" class="color" value="<?php echo $fila['descripcion']; ?>" required>
			...
			<div class="input-field col s12 m8 l6 offset-l1 offset-m1">
				...
				<textarea maxLength="300" id="detalle3" name="detallee3" rows=5 cols=40 class="materialize-textarea" placeholder=" Ingrese el detalle de los servicios que ofrece el restaurante" required><?php echo $fila['detalle']; ?></textarea>
			...
			<div class="input-field col s10 m8 l6 offset-l1 offset-m1">
				...
				<input maxLength="45" type="text" pattern="-?[A-Za-záéíóúÁÉÍÓÚÑñ 0-9 #-]*" id="search" name="ubicacionn3" class="color" placeholder=" Ingrese la direccion" value="<?php echo $fila['ubicacion']; ?>" required>
		...
		<div class="col">
			<div class="input-field col s6 m3 l4 offset-l3 offset-m2">
				<button class="btn #1976d2 blue darken-2" type="submit" name="btnGrabar">ACTUALIZAR</button>
			</div>

			<div class="input-field col s6 m1 l1 offset-l2 offset-m3">
