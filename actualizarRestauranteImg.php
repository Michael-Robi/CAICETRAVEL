...
if(isset($_POST['btnGrabar']))
{
	...
	if($revisar !== false){
		try
		{
			...
			$sql2="UPDATE restaurante SET imagen='$imagen2' WHERE codigo='$codigo'";
...
<div class="row">
	...
	<form class="col s12 m12 l12" name="enviar" method="POST" enctype="multipart/form-data">
			...
			if(isset($error))
			{
			 	foreach($error as $error)
			 	{
					?>
					    ...
					    <?php echo "window.location='actualizarRestauranteImg.php?codigoS=$codigo'"; 
					    ?>    
					    </script> 
	                <?php
				}
		...
		<div class="col">
			...
			<div class="col">
				<div class="input-field col s5 m2 l3 pull-s1 offset-l2 offset-m2" style="margin-top: 0rem;">
					<button class="btn #1976d2 blue darken-2" type="submit" name="btnGrabar">ACTUALIZAR</button>
				</div>

				<div class="input-field col s3 m1 l1 pull-s3 offset-l3 offset-m4" style="margin-top: 0rem;">
				 	<a class="waves-effect waves-light btn green darken-3" href="listaRestaurante.php">Restaurante</a>
				</div>
			</div>
