<?php
  ...
  class cargarBD{
    ...
    function crearXMLHotel($id){
      ...
      $sql1 = "SELECT codigo, descripcion, detalle, ubicacion, TO_BASE64(imagen) as imagen, latitud, longitud, tipo FROM hotel WHERE codigo='". $this->hotel."'";
