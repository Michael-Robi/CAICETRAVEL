...
$sql="SELECT codigo, descripcion, detalle, ubicacion, imagen, tipo FROM bar ORDER BY ubicacion, codigo desc";
    ...
    <body>
      ...
      <div class="container">
        <div class="row">
          ...
          <table class="striped centered">
            ...
            <?php
              while ($fila=$stmt->fetch(PDO::FETCH_ASSOC)) 
              {
                ...
                echo "<td class='espacio'><a class='btn-floating btn-small waves-effect waves-light green' title='Actualizar Bar' href='actualizarBar.php?codigoS=".$fila['codigo']."&tipoS=".$fila['tipo']."'><i class='material-icons'>
                update</i></a></td>"; 

                echo "<td class='espacio'><a class='btn-floating btn-small waves-effect waves-light red' title='Eliminar Bar' href='eliminarBar.php?codigoS=".$fila['codigo']."'><i class='material-icons'>
                delete</i></a></td>";
                ...
                echo "<td class='espacio'><a class='btn-floating btn-small waves-effect waves-light orange' title='Actualizar Imagen' href='actualizarBarImg.php?codigoS=".$fila['codigo']."'><i class='material-icons'>
          ...
          <a class="btn-floating btn-small waves-effect waves-light indigo" title="Insertar Bar" href="barAdmin.php"><i class="material-icons">add</i></a>
