          ...
          <script>
            ...
            Bar: {
              ...
              var infoWindow = new google.maps.InfoWindow;
                ...
                downloadUrl('crearMapaBar.php', function(data) {
                  ...
                  Array.prototype.forEach.call(markers, function(markerElem) {
                    ...
                    var point = new google.maps.LatLng(
                        parseFloat(markerElem.getAttribute('latitud_bar')),
                        parseFloat(markerElem.getAttribute('longitud_bar')));
                    ...
                    var codigo = markerElem.getAttribute('codigo_bar');

                    var descripcion= markerElem.getAttribute('descripcion_bar');

                    var ubicacion= markerElem.getAttribute('ubicacion_bar');

                    var detalle = markerElem.getAttribute('detalle_bar');

                    var imagen= markerElem.getAttribute('imagen_bar');

                    var latitud= markerElem.getAttribute('latitud_bar');
                    var longitud= markerElem.getAttribute('longitud_bar');

                    var tipo= markerElem.getAttribute('tipo_bar');
