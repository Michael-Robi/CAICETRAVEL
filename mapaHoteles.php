                ...
                downloadUrl('<?php print"crearMapaHotelEspecifico.php?codigoS=$hotel"; ?>',
                  ...
                  Array.prototype.forEach.call(markers, function(markerElem) {
                    ...
                    marker.addListener('click', function() {
                      ...
                      infoWindow.setContent('<form action=negocio.php method=post style="background: #F1F1F1;"> <input type="hidden" name="codigoH" value='+codigo+'><input type="hidden" name="tipoH" value='+tipo+'><p class="titulo" for="descripcionH">'+descripcion+'</p><a title="Reservar" href="reservarHotel.php?codigoS='+codigo+'&tipoS='+tipo+'"><img src="data:/jgp;base64,'+imagen+'" class="centrar"><div class="box"></a><p class="datos">'+detalle+'</p></div><p class="direccion">'+ubicacion+'</p><p class="boton"><a class="btn #212121 grey darken-4" href="reservarHotel.php?codigoS='+codigo+'&tipoS='+tipo+'">Reservar</a></p></form>');
