          ...
          <script>
            ...
            Lugar: {
              ...
              var infoWindow = new google.maps.InfoWindow;
                ...
                downloadUrl('crearMapaLugar.php', function(data) {
                  ...
                  Array.prototype.forEach.call(markers, function(markerElem) {
                    ...
                    var point = new google.maps.LatLng(
                        parseFloat(markerElem.getAttribute('latitud_lugar')),
                        parseFloat(markerElem.getAttribute('longitud_lugar')));
                    ...
                    var codigo = markerElem.getAttribute('codigo_lugar');

                    var descripcion= markerElem.getAttribute('descripcion_lugar');

                    var ubicacion= markerElem.getAttribute('ubicacion_lugar');

                    var detalle = markerElem.getAttribute('detalle_lugar');

                    var imagen= markerElem.getAttribute('imagen_lugar');

                    var latitud= markerElem.getAttribute('latitud_lugar');
                    var longitud= markerElem.getAttribute('longitud_lugar');

                    var tipo= markerElem.getAttribute('tipo_lugar');
