          ...
          <script>
            ...
            Restaurante: {
              ...
              var infoWindow = new google.maps.InfoWindow;
                ...
                downloadUrl('crearMapaRestaurante.php', function(data) {
                  ...
                  Array.prototype.forEach.call(markers, function(markerElem) {
                    ...
                    var point = new google.maps.LatLng(
                        parseFloat(markerElem.getAttribute('latitud_restaurante')),
                        parseFloat(markerElem.getAttribute('longitud_restaurante')));
                    ...
                    var codigo = markerElem.getAttribute('codigo_restaurante');

                    var descripcion= markerElem.getAttribute('descripcion_restaurante');

                    var ubicacion= markerElem.getAttribute('ubicacion_restaurante');

                    var detalle = markerElem.getAttribute('detalle_restaurante');

                    var imagen= markerElem.getAttribute('imagen_restaurante');

                    var latitud= markerElem.getAttribute('latitud_restaurante');
                    var longitud= markerElem.getAttribute('longitud_restaurante');

                    var tipo= markerElem.getAttribute('tipo_restaurante');
