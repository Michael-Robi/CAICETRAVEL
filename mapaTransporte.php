          ...
          <script>
            ...
            Transporte: {
              ...
              var infoWindow = new google.maps.InfoWindow;
                ...
                downloadUrl('crearMapaTransporte.php', function(data) {
                  ...
                  Array.prototype.forEach.call(markers, function(markerElem) {
                    ...
                    var point = new google.maps.LatLng(
                        parseFloat(markerElem.getAttribute('latitud_transporte')),
                        parseFloat(markerElem.getAttribute('longitud_transporte')));
                    ...
                    var codigo = markerElem.getAttribute('codigo_transporte');

                    var descripcion= markerElem.getAttribute('descripcion_transporte');

                    var ubicacion= markerElem.getAttribute('ubicacion_transporte');

                    var detalle = markerElem.getAttribute('detalle_transporte');

                    var imagen= markerElem.getAttribute('imagen_transporte');

                    var latitud= markerElem.getAttribute('latitud_transporte');
                    var longitud= markerElem.getAttribute('longitud_transporte');

                    var tipo= markerElem.getAttribute('tipo_transporte');
