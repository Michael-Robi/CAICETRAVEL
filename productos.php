...
<body>
  ...
  <div class="contenedor">
            ...
            <div class="col s3">
              <div class="card" id="tamañoC">
                ...
                <div class="card-content">
                  ...
                  <p><a href="mapaHoteles.php?codigoS='.$codigo.'">Ver en el mapa</a></p>
                  <p><a href="reservarHotel.php?codigoS='.$codigo.'&tipoS='.$tipo.'">Reservar</a></p>
                </div>
    ...
    <?php
    echo '<h3 class="contenedor">Restaurantes</h3> 
          <div class="row">';
  	// while ($fila = $resultado2->fetch_assoc()) {
      $stmt1 = $usuario->runQuery("SELECT * FROM restaurante");
      $stmt1->execute();

      while ($fila=$stmt1->fetch(PDO::FETCH_ASSOC)) {
        $codigo2=$fila['codigo'];
        $imagen2=$fila['imagen']; 
        $nombre2=$fila['descripcion'];
        $detalle2=$fila['detalle'];
        $tipo2=$fila['tipo'];

        echo '<div class="col s3">
                <div class="card" id="tamañoC">
                  <div class="card-image waves-effect waves-block waves-light">
                  <img class="activator" src="data:/jgp;base64,'.base64_encode($imagen2).'" width="500" height="350">   
                </div>
                <div class="card-content">
                  <span class="card-title activator grey-text text-darken-4">'.$nombre2.'<i class="material-icons right"></i></span>
                  <p><a href="#">Ver en el mapa</a></p>
                  <p><a href="reservaSitio.php?codigoS='.$codigo2.'&tipoS='.$tipo2.'">Reservar</a></p>
                </div>
                <div class="card-reveal">
                  <span class="card-title grey-text text-darken-4">'.$nombre2.'<i class="material-icons right">close</i></span>
                  <p>'.$detalle2.'</p>
                </div>
              </div>
            </div>';
    ...
    <?php
    echo '<h3 class="contenedor">Bares</h3> 
          <div class="row">'; 
  	// while ($fila = $resultado3->fetch_assoc()) {
      $stmt1 = $usuario->runQuery("SELECT * FROM bar");
      $stmt1->execute();

      while ($fila=$stmt1->fetch(PDO::FETCH_ASSOC)) {
        $codigo3=$fila['codigo'];
        $imagen3=$fila['imagen']; 
        $nombre3=$fila['descripcion'];
        $detalle3=$fila['detalle'];
        $tipo3=$fila['tipo'];

        echo '<div class="col s3">
                <div class="card" id="tamañoC">
                  <div class="card-image waves-effect waves-block waves-light">
                  <img class="activator" src="data:/jgp;base64,'.base64_encode($imagen3).'" width="500" height="350">   
                  </div>
                  <div class="card-content">
                    <span class="card-title activator grey-text text-darken-4">'.$nombre3.'<i class="material-icons right"></i></span>
                    <p><a href="#">Ver en el mapa</a></p>
                    <p><a href="reservaSitio.php?codigoS='.$codigo3.'&tipoS='.$tipo3.'">Reservar</a></p>
                  </div>
                  <div class="card-reveal">
                    <span class="card-title grey-text text-darken-4">'.$nombre3.'<i class="material-icons right">close</i></span>
                    <p>'.$detalle3.'</p>
                  </div>
                </div>
              </div>';
    ...
    <?php
    echo '<h3 class="contenedor">Lugares</h3> 
          <div class="row">';
  	// while ($fila = $resultado4->fetch_assoc()) {
      $stmt1 = $usuario->runQuery("SELECT * FROM lugar");
      $stmt1->execute();

      while ($fila=$stmt1->fetch(PDO::FETCH_ASSOC)) {
        $codigo4=$fila['codigo'];
        $imagen4=$fila['imagen']; 
        $nombre4=$fila['descripcion'];
        $detalle4=$fila['detalle'];
        $tipo4=$fila['tipo'];

        echo '<div class="col s3">
                <div class="card" id="tamañoC">
                  <div class="card-image waves-effect waves-block waves-light">
                  <img class="activator" src="data:/jgp;base64,'.base64_encode($imagen4).'" width="500" height="350">   
                </div>
                <div class="card-content">
                  <span class="card-title activator grey-text text-darken-4">'.$nombre4.'<i class="material-icons right"></i></span>
                  <p><a href="#">Ver en el mapa</a></p>
                  <p><a href="reservaSitio.php?codigoS='.$codigo4.'&tipoS='.$tipo4.'">Reservar</a></p>
                </div>
                <div class="card-reveal">
                  <span class="card-title grey-text text-darken-4">'.$nombre4.'<i class="material-icons right">close</i></span>
                  <p>'.$detalle4.'</p>
                </div>
              </div>
            </div>';
    ...
    <?php
    echo '<h3 class="contenedor">Transportes</h3>
          <div class="row">';
  	// while ($fila = $resultado5->fetch_assoc()) {
      $stmt1 = $usuario->runQuery("SELECT * FROM transporte");
      $stmt1->execute();

      while ($fila=$stmt1->fetch(PDO::FETCH_ASSOC)) {
        $codigo5=$fila['codigo'];
        $imagen5=$fila['imagen']; 
        $nombre5=$fila['descripcion'];
        $detalle5=$fila['detalle'];
        $tipo5=$fila['tipo'];

        echo '<div class="col s3">
                <div class="card" id="tamañoC">
                  <div class="card-image waves-effect waves-block waves-light">
                  <img class="activator" src="data:/jgp;base64,'.base64_encode($imagen5).'" width="500" height="350">   
                </div>
                <div class="card-content">
                  <span class="card-title activator grey-text text-darken-4">'.$nombre5.'<i class="material-icons right"></i></span>
                  <p><a href="#">Ver en el mapa</a></p>
                  <p><a href="reservaSitio.php?codigoS='.$codigo5.'&tipoS='.$tipo5.'">Reservar</a></p>
                </div>
                <div class="card-reveal">
                  <span class="card-title grey-text text-darken-4">'.$nombre5.'<i class="material-icons right">close</i></span>
                  <p>'.$detalle5.'</p>
                </div>
              </div>
            </div>';
