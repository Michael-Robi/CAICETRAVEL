        ...
        <div class="row"> <!-- row -->
          ...
          <form action="?action=<?php echo $usu->idUsuarios > 0 ? 'actualizar' : 'registrar'; ?>" method="post" class="pure-form pure-form-stacked" onsubmit="return cuentabar();">
            ...
            <div class="input-field col s9 m11 l8">
              ...
              <label class="blanco" style="font-size:12pt;" for="nombre">Usuario</label>
            </div>
            ...
            <div class="input-field col s9 m11 l8">
              ...
              </button> &nbsp; <a class="waves-effect waves-light btn green darken-3" href="registroAdministrador.php">Limpiar</a>
            </div>
