...
if(isset($_POST['btnGrabar']))
{
	...
	if($codigo4=="") {
		...
		try
		{
			$stmt = $administrador->runQuery("SELECT codigo, descripcion, ubicacion, latitud, longitud FROM transporte WHERE codigo=:codigo4 OR descripcion=:descripcion4 OR ubicacion=:ubicacion4 OR latitud=:latitud4 OR longitud=:longitud4");
			$stmt->execute(array(':codigo4'=>$codigo4, ':descripcion4'=>$descripcion4, ':ubicacion4'=>$ubicacion4, ':latitud4'=>$latitud4, ':longitud4'=>$longitud4));
			$row=$stmt->fetch(PDO::FETCH_ASSOC);
				
			if($row['codigo']==$codigo4) {
				$error[] = "El código del transporte ya existe,\\npor favor digite otro código";
			}

			else if($row['descripcion']==$descripcion4) {
			...
			{
				$sql4="INSERT INTO transporte values(
				'$codigo4',
				'$descripcion4','$detalle4','$ubicacion4',
				'$imagen4','$latitud4','$longitud4','Transporte')";

				$stmt=$administrador->runQuery($sql4);
				$stmt->execute();

				echo'<script type="text/javascript">
	      		alert("Transporte Registrado");     
	      		window.location="transporteAdmin.php"
	     		</script>';
			}
		}
...
<head>
	...
	<title>Transporte Administrador</title>
	...
	<form class="col s12 m12 l12" name="enviar" method="POST" enctype="multipart/form-data">
		...
		<div class="col">
			...
			<div style="margin-top: 0rem;" class="input-field col s12 m8 l6 offset-l1 offset-m1">
				...
				<article>
					<h5 class="color">GUARDAR TRANSPORTE</h5>
				</article>
			</div>
			...
			<div class="input-field col s12 m8 l6 offset-l1 offset-m1">
				...
				<input maxLength="10" type="text" id="codigoo" name="codigoo4" onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;"	placeholder=" Ingrese el codigo" class="color" value="<?php if(isset($error)){echo $codigo4;}?>" required>
		    ...
		    <div class="input-field col s12 m8 l6 offset-l1 offset-m1">
				...
				<input maxLength="30" type="text" pattern="-?[A-Za-záéíóúÁÉÍÓÚÑñ #-]*" id="descripcionn" name="descripcionn4" placeholder=" Ingrese el nombre del transporte" class="color" value="<?php if(isset($error)){echo $descripcion4;}?>" required>
			...
			<div class="input-field col s12 m8 l6 offset-l1 offset-m1">
				...
				<textarea maxLength="300" id="detalle4" name="detallee4" rows=5 cols=40 class="materialize-textarea" placeholder=" Ingrese el detalle de los servicios que ofrece el transporte" required><?php if(isset($error)){echo $detalle4;}?></textarea>
			...
			<div class="input-field col s10 m8 l6 offset-l1 offset-m1">
				...
				<input maxLength="45" type="text" pattern="-?[A-Za-záéíóúÁÉÍÓÚÑñ 0-9 #-]*" id="search" name="ubicacionn4" class="color" placeholder=" Ingrese la direccion" value="<?php if(isset($error)){echo $ubicacion4;}?>" required>
			...
			<div class="input-field col s9 m8 l6 offset-l1 offset-m1" style="margin-top: 0rem;">
				<div class="file-field input-field">
		            <div class="btn #1976d2 blue darken-2">
		              <span>Adjuntar Imagen Transporte</span>
		              <input type="file" id="imagen" name="imagen4" accept="image/jpeg,image/png" required>
		            </div>
            ...
            <!-- <div class="input-field col s7 m8 l6 offset-l1 offset-m1"> -->
              ...
              <input type="hidden" id="latitud" name="latitud" value="<?php if(isset($error)){echo $latitud4;}?>" placeholder=" Latitud" required>
            ...
            <!-- <div class="input-field col s7 m8 l6 offset-l1 offset-m1"> -->
              <!-- <i class="material-icons prefix">location_on</i> -->
              <input type="hidden" id="longitud" name="longitud" value="<?php if(isset($error)){echo $longitud4;}?>" placeholder=" Longitud" required>
