...
{
    $miUsuario->redireccionar('principal.php');
}
...
if(isset($_POST['btn-login']))//Si es presionado el botón Ingresar
{
    ...
    if($miUsuario->doLogin($uname,$umail,$upass))
    {
        $miUsuario->redireccionar('principal.php');
    }
    else
...
<html lang="es">
  ...
  <style>
    body {
      background: url(imagenes/loggin.png);
      ...
      <div id="container">
        ...
        <div class="color" style="display: inline-block; padding: 0px 39px 0px 39px;"> 
          <form class="col s12 m12 l12" name="Ingresar" method="post">
            ...
            <h5>¡No tienes cuenta! <a style="color:#00FFFF" href="registro.php">Regístrate</a></h5>
